...
export default async function RootLayout({
  ...
  return (
    <html lang={dic.locale} suppressHydrationWarning>
      <SpeedInsights />
      <body
        className={`${firaCode.className} font-medium bg-background text-primary`}
      >
        <ThemeProvider attribute="class" defaultTheme="light" enableSystem>
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-gradient-to-b from-transparent to-background h-36" />
        </ThemeProvider>
      </body>
    </html>
  );
