  ...
  return (
    <div className="md:p-4 lg:px-6 space-y-3 text-base">
      ...
      <div className="space-y-2">
        ...
        <p>
          {aboutMe.youCanView}
          <Link href="/projects" className="text-blue-700 hover:underline"> {aboutMe.here} </Link>
          {aboutMe.orAt}
          <Link href="https://github.com/erickcestari" target="_blank" className="text-blue-700 hover:underline"> github</Link>.
        </p>
      </div>
