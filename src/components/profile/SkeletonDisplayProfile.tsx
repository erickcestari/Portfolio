const SkeletonDisplayProfile = () => {
  return (
    <div className='flex animate-pulse justify-center items-center flex-col md:items-start md:justify-normal space-y-2'>
      <div className='bg-gray-300 shadow-2xl dark:bg-zinc-950 rounded-lg w-72 h-72 md:h-64 md:w-64'/>
